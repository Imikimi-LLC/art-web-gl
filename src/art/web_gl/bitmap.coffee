...
{rgbColor, Color, point, Point, rect, Rectangle, matrix, Matrix} = Atomic
{eq, inspect, defineModule} = Foundation

white = rgbColor 1,1,1,1

superSuperConstructor = Canvas.BitmapBase.__super__.constructor

defineModule module, class Bitmap extends Canvas.BitmapBase
  ...
  toMemoryBitmap: ->
    ...
    if @isTexture
      ...
      memoryBitmap.clear rgbColor 0, 0, 0, 0 # we should be able to do this just with drawBitmap and the right blend mode
